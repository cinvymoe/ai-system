  ...
  export default defineConfig({
    // Set base path to relative for Electron production builds
    ...
    build: {
      target: 'esnext',
      // Change output directory to 'dist' for Electron compatibility
      outDir: 'dist',
      emptyOutDir: true,
    },
    server: {
      // Ensure dev server runs on port 3000 (matches Electron main.ts)
      port: 3000,
